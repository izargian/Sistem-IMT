                    ...
                    ?>
                      <tr>
                        ...
                        <td class="align-middle text-center">
                          ...
                          <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:void(0)" data-url="<?= site_url('petugas/change/data_member_teknisi/delete_teknisi_member/' . $u->id); ?>" onclick="delete_member(this)"><i class="far fa-trash-alt me-2"></i></a>
